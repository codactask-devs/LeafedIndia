...
const RotatingQuotes: React.FC = () => {
    ...
    return (
        <section
            className="w-full py-10 md:py-35x bg-white bg-cover bg-center bg-no-repeat"
        ...
        >
            <div className="max-w-4xl mx-auto px-6 text-center">
                ...
                {/* Quote */}
                <p
                    className={`text-[#1a2b4b] text-xl md:text-3xl lg:text-4xl font-bold leading-snug md:leading-tight transition-all ${isVisible ? "opacity-100" : "opacity-0"}`}
