    ...
    return (
        <section className="w-full bg-[#f6f3e5] py-20 px-4 md:px-10">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 items-start justify-between">
                ...
                <div className="w-full sm:flex sm:gap-6 lg:flex-col lg:w-[24%] gap-6 flex flex-col lg:pt-12">
                    ...
                    <div className="w-full h-[280px] sm:h-[360px] lg:h-[360px] overflow-hidden rounded-[24px] md:rounded-[32px] shadow-sm">
                        <img
                            ...
                            className="w-full h-full object-cover hover:scale-103 transition-transform duration-500 animate-fade-in"
                        />
                    </div>
                </div>

                <div className="w-full lg:w-[28%] lg:pt-24 flex">
